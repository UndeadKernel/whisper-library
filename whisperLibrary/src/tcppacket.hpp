...
public:
	...
	/** \brief Create a packet based of a given boolean vector.
		\param content The content to fill the packet
     */
	...
	*/
	...
	/** \returns the acknowledge number
	*/
	...
	*/
	...
	/** \param data Set the data of the packet.
	*/
