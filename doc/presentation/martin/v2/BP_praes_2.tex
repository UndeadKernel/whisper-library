...
\begin{document}
	...
	\subtitle{Martin Oehler, Gruppe 35 }
	
 	% Fußzeile
	\author{S. Kadel, J.S. Bunten, M.S. Oehler, A.S. Stühlmeier}
	\date{\today}
...
\frametitle{Einführung}
	...
	\begin{minipage}{.55\linewidth}
		...
		\begin{itemize}
			...
			\item Vermeiden von Entdeckung, Abhören und Abfangen
		\end{itemize}	
	\end{minipage}
	\hfill
	...
	\begin{description}
		\item {}
		\item{}
		\item[Kryptographie] <2>Verschlüsselt die Daten, Kanal bleibt sichtbar
...
\begin{frame}
	...
	\begin{itemize}
		\item <2>öffnet und verwendet Covert Channels
		\item <2>Implementierung eines Frameworks
		\item <2>konkrete Covert Channels als Plugin
		\item <2>Veröffentlichung als Open Source
	\end{itemize}
	\begin{center}
...
\frametitle{Zusammenfassung}
	...
	\begin{itemize}
		...
		\item nutzbar für möglichst viele Covert Channels
	\end{itemize}
	\end{minipage}
\end{frame}
